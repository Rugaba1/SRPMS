...
<center><br>
    <main>
        ...
        <form action="UserEdit.jsp" method="POST">
            ...
            <input type="text" name="regno" value="<%=rs.getString(2)%>" required/>
            <label>Firstname :</label>
            <input type="text" name="fname" value="<%=rs.getString(3)%>" required/>
            <label>Lastname :</label>
            <input type="text" name="lname" value="<%=rs.getString(4)%>" required/>
            <label>Username :</label>
            <input type="text" name="uname" value="<%=rs.getString(5)%>" required/>
            <label>Password :</label>
            <input type="password" name="pass" value="<%=rs.getString(6)%>" required/><br>
       ...
       <%
        ...
        String upd="UPDATE user SET uid = ?,Reg_No = ?,Firstname = ?,Lastname = ?,Username = ?,Password = ? WHERE uid ='"+id+"'";
