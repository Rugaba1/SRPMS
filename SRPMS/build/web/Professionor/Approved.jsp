...
<body>
   ...
   <nav>
    ...
    <br>
<center>
    <p style="color: #2c3e50; padding: 10px; font-weight: bold; transition: color 0.3s;">Those are The All Request You have sent and Their Status</p>
    ...
    <table>
        ...
        String sql = "SELECT user.Firstname,questions.Description,answers.Description,professionor.Firstname FROM user JOIN questions ON user.uid = questions.uid JOIN answers ON questions.qid = answers.qid JOIN professionor ON answers.pid = professionor.pid";
