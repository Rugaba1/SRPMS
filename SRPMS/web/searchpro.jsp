...
<body>
    ...
    <nav>
        ...
        <a href="AdminQuestion.jsp">Question-List</a>
        <a href="DisplayUser.jsp">Students</a>
        <a href="DisplayPro.jsp">Professionors</a>
    ...
    <input type="text" name="sea" placeholder="Search a Profession Here!" required/>
    ...
    <table>
        ...
        String sql = "SELECT * FROM professionor WHERE Firstname = '"+s+"'";
        ...
        <tr>
            ...
            <td><button style="background-color: #339900; font-weight: bold; border: none; height: 40px; color: white;"><a href="ProEdit.jsp?id=<%= id%>" style="color: white;">Edit</a></button>
                <button style="background-color: #cc0000; font-weight: bold; border: none; height: 40px; color: white;"><a href="ProDelete.jsp?id=<%= id%>" style="color: white;">Delete</a></button>
            </td>
        </tr>
        <%
