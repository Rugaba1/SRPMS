...
<body>
    ...
    <br>
    <center>
    <p style="color: #2c3e50; padding: 10px; font-weight: bold; transition: color 0.3s;">Those are The All Request  sent and Their Status</p>
    <form action="searchq.jsp" method="POST">
    ...
    <table>
        ...
        String sql = "SELECT questions.qid,user.Firstname,questions.Description,answers.Description,professionor.Firstname FROM user JOIN questions ON user.uid = questions.uid JOIN answers ON questions.qid = answers.qid JOIN professionor ON answers.pid = professionor.pid";
        ...
        <tr>
            ...
            <td><button style="background-color: #cc0000; font-weight: bold; border: none; height: 40px; color: white;"><a href="AnsDelete.jsp?id=<%= id%>" style="color: white;">Delete</a></button></td>
        </tr>
        <%
