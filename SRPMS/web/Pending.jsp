...
<body>
    ...
    <br>
    <center>
    <p style="color: #2c3e50; padding: 10px; font-weight: bold; transition: color 0.3s;">Those are The Pending Request!</p>
    ...
    <table>
        ...
        String sql = "SELECT user.Firstname, questions.Description FROM user JOIN questions ON user.uid = questions.uid LEFT JOIN answers ON questions.qid = answers.qid WHERE answers.qid IS NULL";
